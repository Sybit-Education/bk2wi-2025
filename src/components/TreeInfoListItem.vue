...
<template>
  <div class="tree-info-item p-4 border rounded-lg shadow-sm hover:shadow-md transition-shadow">
    ...
    <div class="mt-2 text-sm text-gray-600">
      <p v-if="tree.species"><span class="font-medium">Art:</span> {{ tree.species }}</p>
      <p v-if="tree.location"><span class="font-medium">Standort:</span> {{ tree.location }}</p>
      ...
      <p v-if="tree.last_inspection" class="mt-2 text-xs text-gray-500">
